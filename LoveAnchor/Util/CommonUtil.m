...
+ (LevelInfoModel *)getLevelInfoWithCoin:(NSInteger)coin isRich:(BOOL)isRich
{
    ...
    if (isRich) {
        ...
        } else if (coin >= 5378100 && coin < 11800000) {
            level = 21;
            nextCoin = 11800000 - coin;
        } else if (coin >= 11800000 && coin < 25800000) {
            level = 22;
            nextCoin = 25800000 - coin;
        } else if (coin >= 25800000 && coin < 51800000) {
            level = 23;
            nextCoin = 51800000 - coin;
        } else if (coin >= 51800000 && coin < 108000000) {
            level = 24;
            nextCoin = 108000000 - coin;
        } else if (coin >= 108000000 && coin < 168000000) {
            level = 25;
            nextCoin = 168000000 - coin;
        } else if (coin >= 168000000 && coin < 258000000) {
            level = 26;
            nextCoin = 258000000 - coin;
        } else if (coin >= 258000000) {
            level = 27;
            nextCoin = 0;
        }
    } else {
        ...
        } else if (coin >= 58465000 && coin < 68000000) {
            level = 55;
            nextCoin = 68000000 - coin;
        } else if (coin >= 68000000 && coin < 88000000) {
            level = 56;
            nextCoin = 88000000 - coin;
        } else if (coin >= 88000000 && coin < 118000000) {
            level = 57;
            nextCoin = 118000000 - coin;
        } else if (coin >= 118000000 && coin < 168000000) {
            level = 58;
            nextCoin = 168000000 - coin;
        } else if (coin >= 168000000 && coin < 258000000) {
            level = 59;
